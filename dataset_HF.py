...
class ImageDataset(torch.utils.data.Dataset):
    def __init__(self, root_dir, setting='train', overfit=False, truncate=-1, transform=None, dragon=False, dragon_root='DRAGON_train_embeddings/', clip_model_name="laion/CLIP-ViT-B-32-laion2B-s34B-b79K"):
    ...
    def get_data(self, root_dir):
        ...
        with open(root_dir + 'train' + '_CLIP_list_of_textprompts.pickle', 'rb') as fi:
    ...
    def __getitem__(self, idx):
        ...
        inputs = self.processor(textprompt, images=image, return_tensors="pt", padding=True, truncation=True)
        ...
        if self.dragon:
            with open(self.dragon_root + self.dragon_filenames[idx], 'rb') as fi:
                ...
                dragon_embedding = dragon_embedding * 0


            return inputs['pixel_values'][0], inputs['input_ids'][0], dragon_embedding
        else:
